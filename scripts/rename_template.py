...
It renames all the occurrences of Pavlov (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the Pavlov folder
        os.rename(
            os.path.join(root_dir_path, "exts", "Pavlov", "Pavlov"),
            os.path.join(root_dir_path, "exts", "Pavlov", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "Pavlov"), os.path.join(root_dir_path, "exts", new_name))
