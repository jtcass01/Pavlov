...
- Throughout the repository, the name `Pavlov` only serves as an example and we provide a script to rename all the references to it automatically:

```
# Rename all occurrences of Pavlov (in files/directories) to your_fancy_extension_name
